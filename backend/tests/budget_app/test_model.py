...
@pytest.mark.django_db
def test_account_sum_functions_positive_and_negative(create_user, create_custom_transaction):
    user = create_user
    account = Account.objects.create(user=user, name='account1',
                                    description='Random description')
...
@pytest.mark.django_db
def test_account_sum_functions_negative_only(create_user, create_custom_transaction):
    user = create_user
    account = Account.objects.create(user=user, name='account1',
                                    description='Random description')
...
@pytest.mark.django_db
def test_account_sum_functions_positive_only(create_user, create_custom_transaction):
    user = create_user
    account = Account.objects.create(user=user, name='account1',
                                    description='Random description')
